...
from app.api import chat, kb, profile, evaluation, products
...
app = FastAPI(
    ...
    description="Evidence-grounded skincare consultation, product recommendations, safety guardrails, and knowledge base administration.",
    version="2.0.0"
)
